        ...
        <div id="content" class=" container mt-5 mb-5">
            ...
            <div class="box table-holder shadow p-3 mt-3 ">
                <div class="text-end mt-3">
                    <button type="button" class="btn btn-primary w-50" data-bs-toggle="modal" data-bs-target="#exampleModal">Request Withdraw</button>
                </div>
                <div class="mt-3 mb-3">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form id="withdrawForm">
                <small class="text-muted">Note: Minimum withdrawal is 500.</small><hr>
                <input type="hidden" name="action" value="cWithdrawRequest" >
